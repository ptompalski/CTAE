...
- Manitoba: `vol_klos2004()` - Individual tree volume using parameters developed by Klos (2004)
...
Klos, R. J. (2004). Stem taper and volume equations for major tree species in Manitoba. M.Sc. thesis, University of Manitoba, Winnipeg, MB, Canada.
