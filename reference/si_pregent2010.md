...
- age:
  ...
  emitted when `age > 60`, because that exceeds the published range.
...
plantation ages up to 60 years. This implementation warns when
`age > 60` and returns extrapolated values.
