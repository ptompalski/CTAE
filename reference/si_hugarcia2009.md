...
- species:
  ...
  Character vector of NFI species codes (`"PICE.GLA"` or `"PICE.ENG"`).
...
**Age definition note:** `age` is breast-height age (years). The height
curve passes through the origin \\(t_0, H_0) = (0.5\\\mathrm{yr},
