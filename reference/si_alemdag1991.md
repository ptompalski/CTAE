...
**Age definition note:** `age` is breast-height age (years), i.e. rings
counted at 1.30 m. Both equations use height and site index measured
above breast height (\\H - 1.30\\, \\S - 1.30\\).
