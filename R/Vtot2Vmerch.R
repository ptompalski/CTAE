...
Vtot2Vmerch <- function(
  ...
  if (!is.numeric(total_volume)) {
    stop("'total_volume' must be type numeric")
  }
...
Vtot2Vmerchgetparams <- function(genus, jurisdiction, ecozone) {
